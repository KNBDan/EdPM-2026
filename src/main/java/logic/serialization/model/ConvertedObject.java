...
public class ConvertedObject {
    ...
    public ConvertedObject(ArrayList<Line_s> currentLine, ArrayList<Figure_s> currentFigures, int zoom,
        ...
        this.idO = idO;
        this.idIF = idIF;
        this.generationSettings = GenerationSettings.defaults();
    }

    public ConvertedObject(ArrayList<Line_s> currentLine, ArrayList<Figure_s> currentFigures, int zoom,
            int idS, int idNV, int idV, int idR, int idO, int idIF, GenerationSettings generationSettings) {
        this(currentLine, currentFigures, zoom, idS, idNV, idV, idR, idO, idIF);
        this.generationSettings = generationSettings != null ? generationSettings : GenerationSettings.defaults();
    }
